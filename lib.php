...
function get_ead_course_common_actions() 
{
    ...
    if ($PAGE->pagelayout == "course" || $PAGE->pagelayout == "incourse") {
        ...
        $notas->icon = "table";
        $notas->label = get_string('grades', 'theme_ead');
        $extraflatnav[] = $notas;
        ...
        $participantes->label = get_string('participants', 'theme_ead');
        ...
        $emblemas->label = new lang_string('badges', 'badges'); // TODO LANG Emblemas
